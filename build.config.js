...
module.exports = {
  ...
  vendor_files: {
    ...
    appcache_literals: [
        ...
        'http://netdna.bootstrapcdn.com/fonts/fontawesome-webfont.eot?v=4.1.0',
        'http://netdna.bootstrapcdn.com/fonts/fontawesome-webfont.eot?#iefix&v=4.1.0',
        'http://netdna.bootstrapcdn.com/fonts/fontawesome-webfont.woff?v=4.1.0',
        'http://netdna.bootstrapcdn.com/fonts/fontawesome-webfont.ttf?v=4.1.0',
        'http://netdna.bootstrapcdn.com/fonts/fontawesome-webfont.svg?v=4.1.0#fontawesomeregular',
